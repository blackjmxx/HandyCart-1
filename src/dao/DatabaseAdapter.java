...
public class DatabaseAdapter extends SQLiteOpenHelper {
    ...
    public Product getProductByName(String Name) {
        ...
        String sql = "SELECT prd.prd_id, prd.prd_code_barre, prd.libelle, prd.prd_prix, prd.prd_description, mqp.mqp_libelle, ctp.ctp_libelle, ctp.ctp_localisation, fmp_libelle FROM fmp_famille_produit fmp INNER JOIN ctp_categorie_produit ctp ON (fmp.fmp_id = ctp.fmp_id) INNER JOIN prd_produit prd ON (ctp.ctp_id = prd.ctp_id) INNER JOIN mqp_marque_produit mqp ON (prd.mqp_id = mqp.mqp_id) WHERE prd.libelle = '"
                + Name + "'";
    ...
    public ArrayList<Product> getProductsByCategoryName(String categoryName) {
        ...
        String sql = "SELECT prd.prd_id, prd.prd_code_barre, prd.libelle, prd.prd_prix, prd.prd_description, mqp.mqp_libelle, ctp.ctp_libelle, ctp.ctp_localisation, fmp_libelle FROM fmp_famille_produit fmp INNER JOIN ctp_categorie_produit ctp ON (fmp.fmp_id = ctp.fmp_id) INNER JOIN prd_produit prd ON (ctp.ctp_id = prd.ctp_id) INNER JOIN mqp_marque_produit mqp ON (prd.mqp_id = mqp.mqp_id) WHERE ctp.ctp_libelle = '"
                + categoryName + "'";
